...
final class LLMPromptTests: XCTestCase {
    ...
    func testLearningAidsPromptRequestsStructuredPitfallsMnemonicsAndCollocations() {
        ...
        XCTAssertTrue(prompt.user.contains("Bad pitfall: collocation -> \"Mistake in using 'habitual' vs. 'regular'\""))
        ...
        XCTAssertTrue(prompt.user.contains("Bad collocation: collocation -> \"reluctant to admit\""))
